...
[Skip to main content](https://templ.guide/syntax-and-usage/comments#__docusaurus_skipToContent_fallback)
...
```
templ template() {	<!-- Single line -->	<!--		Single or multiline.	-->}
```
...
```
<!-- Single line --><!--	Single or multiline.-->
```
...
```
package main// Use standard Go comments outside templ statements.var greeting = "Hello!"templ hello(name string) {	<p>{greeting} { name }</p>}
```

[Edit this page](https://github.com/a-h/templ/tree/main/docs/docs/03-syntax-and-usage/13-comments.md)

[Previous Using JavaScript with templ](https://templ.guide/syntax-and-usage/script-templates)[Next Context](https://templ.guide/syntax-and-usage/context)
