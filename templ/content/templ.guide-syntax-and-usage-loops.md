For loops | templ docs
===============

[Skip to main content](https://templ.guide/syntax-and-usage/loops#__docusaurus_skipToContent_fallback)
...
```
package maintempl nameList(items []Item) {  <ul>  for _, item := range items {    <li>{ item.Name }</li>  }  </ul>}
```
...
[Edit this page](https://github.com/a-h/templ/tree/main/docs/docs/03-syntax-and-usage/08-loops.md)

[Previous Switch](https://templ.guide/syntax-and-usage/switch)[Next Raw Go](https://templ.guide/syntax-and-usage/raw-go)
