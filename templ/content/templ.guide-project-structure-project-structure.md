...
Application architecture[​](https://templ.guide/project-structure/project-structure#application-architecture "Direct link to Application architecture")
-------------------------------------------------------------------------------------------------------------------------------------------------------
