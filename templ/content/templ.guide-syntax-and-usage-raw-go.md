...
[Skip to main content](https://templ.guide/syntax-and-usage/raw-go#__docusaurus_skipToContent_fallback)
...
Variable declarations[​](https://templ.guide/syntax-and-usage/raw-go#variable-declarations "Direct link to Variable declarations")
----------------------------------------------------------------------------------------------------------------------------------
...
```
package maintempl nameList(items []Item) {    {{ first := items[0] }}    <p>        { first.Name }    </p>}
```
...
[Edit this page](https://github.com/a-h/templ/tree/main/docs/docs/03-syntax-and-usage/09-raw-go.md)

[Previous For loops](https://templ.guide/syntax-and-usage/loops)[Next Template composition](https://templ.guide/syntax-and-usage/template-composition)

*   [Variable declarations](https://templ.guide/syntax-and-usage/raw-go#variable-declarations)
